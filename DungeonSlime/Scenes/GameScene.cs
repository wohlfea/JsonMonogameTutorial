...
public class GameScene : Scene
{
    ...
    public override void LoadContent()
    {
        ...
        TextureAtlas atlas = TextureAtlas.FromFile(Core.Content, "images/atlas_definition.json");
    ...
    private void CheckKeyboardInput()
    {
        ...
        if (keyboard.IsKeyDown(Keys.W) || keyboard.IsKeyDown(Keys.Up) || keyboard.IsKeyDown(Keys.K))
        {
            _slimePosition.Y -= speed;
        }

        // if the S or Down keys are down, move the slime down on the screen.
        if (keyboard.IsKeyDown(Keys.S) || keyboard.IsKeyDown(Keys.Down) || keyboard.IsKeyDown(Keys.J))
        {
            _slimePosition.Y += speed;
        }

        // If the A or Left keys are down, move the slime left on the screen.
        if (keyboard.IsKeyDown(Keys.A) || keyboard.IsKeyDown(Keys.Left) || keyboard.IsKeyDown(Keys.H))
        {
            _slimePosition.X -= speed;
        }

        // If the D or Right keys are down, move the slime right on the screen.
        if (keyboard.IsKeyDown(Keys.D) || keyboard.IsKeyDown(Keys.Right) || keyboard.IsKeyDown(Keys.L))
        {
            _slimePosition.X += speed;
        }
